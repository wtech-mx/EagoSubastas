        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 au-deals">
                    ...
                    <h2 class="text-center"> <?php echo e(getPhrase('upcoming_auctions')); ?> </h2>
                </div>
            </div>
            ...
            <div class="row au-line-bottom bar-line" style="background-color: #fff">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12">
                    <div class="au-bidding live">
                        <a href="<?php echo e(URL_HOME_AUCTION_DETAILS); ?>/<?php echo e($auction->slug); ?>" title="Auction Details" class="btn btn-default rounded au-space au-btn-modren login-bttn"> <?php echo e(getPhrase('happening_now')); ?></a>
