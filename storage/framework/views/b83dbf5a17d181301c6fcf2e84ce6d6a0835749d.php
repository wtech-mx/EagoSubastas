            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 au-deals">
                 ...
                 <?php if(count($latest_auctions)): ?>
                    ...
                    .card-<?php echo str_limit($auction->id); ?> .card-img,
                    .card-<?php echo str_limit($auction->id); ?> .card-img-hovered {
                      background-image:url(<?php echo e(getAuctionImage($auction->image,'auction')); ?>);
                    }

                    </style>

                      <div class="card card-<?php echo str_limit($auction->id); ?>">
                        <div class="card-img"></div>
                        <a href="<?php echo e(URL_HOME_AUCTION_DETAILS); ?>/<?php echo e($auction->slug); ?>" class="card-link">
                          <div class="card-img-hovered"></div>
                        </a>
                        <div class="card-info text-center">

                          <h1 class="card-title"><strong><?php echo str_limit($auction->title,40,'..'); ?></strong></h1>
                            <div class="card-creator au-notification rounded">
                                <a class="text-white" href="<?php echo e(URL_HOME_AUCTION_DETAILS); ?>/<?php echo e($auction->slug); ?><?php echo e($auction->slug); ?>"><?php echo e($currency_code); ?> <?php echo e($auction->reserve_price); ?></a>
                            </div>
