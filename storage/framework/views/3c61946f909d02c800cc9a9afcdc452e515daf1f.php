                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="au-accordina">
                                        ...
                                        <div class="au-acord-secret">
                                            <h6 class="card-title text-center" data-toggle="tooltip" title="<?php echo e($auction->title); ?>" data-placement="bottom">
                                                <a href="<?php echo e(URL_HOME_AUCTION_DETAILS); ?>/<?php echo e($auction->slug); ?>"><?php echo str_limit($auction->title,25,'..'); ?></a>
                                            </h6>
                                 ...
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                   ...
                                   <div class="col-lg-12 col-md-12 col-sm-12"> 
                                    <div class="text-center">
                                          ...
                                          <a href="<?php echo e(URL_HOME_AUCTIONS); ?>" class="btn btn-primary login-bttn">Ver mas</a>
                                    </div>
                                  </div>
