    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('city_create')): ?>
                 ...
                 <a href="<?php echo e(URL_CITIES_ADD); ?>" class="btn btn-success btn-add pull-right"> Agregar </a>
            <?php endif; ?>
                            ...
                            <tr data-entry-id="<?php echo e($city->id); ?>">
                                ...
                                <td>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('city_view')): ?>
                                        ...
                                        <a href="<?php echo e(URL_CITIES_VIEW); ?>/<?php echo e($city->slug); ?>" class="btn btn-xs btn-primary"> Ver </a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('city_edit')): ?>

                                        <a href="<?php echo e(URL_CITIES_EDIT); ?>/<?php echo e($city->slug); ?>" class="btn btn-xs btn-info"> Editar </a>
                                    <?php endif; ?>

                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('city_delete')): ?>

                                        <a class="btn btn-xs btn-danger" href="javascript:void(0)" onclick="deleteRecord('<?php echo e($city->id); ?>')"> Borrar </a>
                                    <?php endif; ?>
                                </td>
